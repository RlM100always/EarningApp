...
public class TrnxModelMain {

    String count,balancePoints,names,date,payColor,postKey,status,trnxId,uid,image;

    public TrnxModelMain(){

    }

    public TrnxModelMain(String count, String balancePoints, String names, String date, String payColor, String postKey, String status, String trnxId, String uid, String image) {
        this.count = count;
